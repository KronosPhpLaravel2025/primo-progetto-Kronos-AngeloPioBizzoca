...
<html lang="en">
  ...
  <body>
    ...
    <div class="container d-flex justify-content-center align-items-center mt-3 flex-column">
      <form class="w-50 p-4 bg-light rounded shadow-sm">
        ...
        <div class="mb-3"><label for="exampleFormControlTextarea1" class="form-label">Message</label><textarea class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea></div><button type="submit" class="btn btn-outline-secondary w-100">Submit</button>
      </form>
    </div>
