  ...
  <body>
    ...
    <div id="carouselExample" class="carousel slide" data-bs-ride="carousel" data-bs-interval="1500">
      <div class="carousel-inner text-center">
        ...
        <div class="carousel-item"><img src="https://universoftware.co.uk/static/2021/08/cybersecurity.jpg" class="d-block mx-auto img-fluid w-50" style="height: 350px; object-fit: cover;" alt="cyber-security"></div>
        <div class="carousel-item"><img src="https://www.musaformazione.it/wp-content/uploads/2019/01/digital-marketing.jpeg" class="d-block mx-auto img-fluid w-50" style="height: 350px; object-fit: cover;" alt="digital-marketing"></div>
        <div class="carousel-item"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTwzvhEaV6HSsc8RuJhzsdZT1ozcP0QNDg8XQ&s" class="d-block mx-auto img-fluid w-50" style="height: 350px; object-fit: cover;" alt="data-analyst"></div>
        <div class="carousel-item"><img src="https://blog.cptc.edu/wp-content/uploads/2024/03/Coaching-vs-mentoring-blog-jpg.webp" class="d-block mx-auto img-fluid w-50" style="height: 350px; object-fit: cover;" alt="team-training-and-coaching"></div>
        <div class="carousel-item"><img src="https://media.licdn.com/dms/image/v2/D4D12AQFIZgbpY7gVUA/article-cover_image-shrink_600_2000/article-cover_image-shrink_600_2000/0/1678144581767?e=2147483647&v=beta&t=S-7eIxpmmbKNZz9lRf2c9ig7ShPHYc425kRtJgjjgNo" class="d-block mx-auto img-fluid w-50" style="height: 350px; object-fit: cover;" alt="web-sites-conculence"></div>
        <div class="carousel-item"><img src="https://t3.ftcdn.net/jpg/01/37/63/46/360_F_137634615_QFjSm4oFRKMTt7I1Y3yqi3LV39pqBucS.jpg" class="d-block mx-auto img-fluid w-50" style="height: 350px; object-fit: cover;" alt="human-resources"></div>
      </div>
    </div>
          ...
          <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
            ...
            <div class="d-flex justify-content-center justify-content-md-start">
              <div class="d-flex flex-column me-3">
                ...
                <img src="https://cdn-icons-png.flaticon.com/128/2991/2991147.png" alt="Google" class="img-fluid mb-2" style="width:25px; height:25px;">
                <img src="https://cdn-icons-png.flaticon.com/128/25/25657.png" alt="Github" class="img-fluid mb-2" style="width:25px; height:25px;">
              ...
              <div class="d-flex flex-column">
                ...
                <a href="#!" class="text-body text-decoration-none mb-2 fw-light">X</a></div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
