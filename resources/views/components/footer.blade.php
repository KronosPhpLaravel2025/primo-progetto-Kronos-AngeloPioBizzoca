    ...
    <div class="row justify-content-center gx-5">
      ...
      <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
        ...
        <ul class="list-unstyled mb-0 text-center small">
          ...
          <li class="mb-2">
            <a class="text-body fw-light text-decoration-none">Operational Office: Via dei Lavoratori 3, Milan, Italy</a>
          </li>
          <li class="mb-2">
            <a class="text-body fw-light text-decoration-none">P.IVA: 1234567890</a>
          </li>
          <li class="mb-2">
            <a class="text-body fw-light text-decoration-none">Email: kronos@example.com</a>
          </li>
        </ul>
      </div>
    </div>
